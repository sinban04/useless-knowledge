...
![우물 특성 → 거시 물성 마스터 표](images/well_to_property.png)

*우물의 네 기하 특성이 우리가 측정하는 거시 물성으로 그대로 번역된다.*
*깊이는 융점으로: CH₄ −182, NaCl 801, W 3422, 다이아 >3500 °C.*
*곡률은 강성으로: 폴리머 0.1–4, Cu 120, 다이아 1100 GPa.*
*비대칭은 열팽창으로: 다이아 1.0, 폴리머 50–200 (×10⁻⁶ K⁻¹, 약 200배 span).*
*방향성은 가공성으로: 비방향+부호교대=취성, 비방향+바다=연성, 방향성=경질.*
